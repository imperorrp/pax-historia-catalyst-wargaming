...
export const metadata: Metadata = {
  title: "Wargaming Prototype",
  description: "Visual Catalyst Prototype for Pax Historia",
  generator: "v0.app",
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`font-sans antialiased ${baskerville.variable} ${ibmPlexMono.variable}`}>
        {children}
        <Analytics />
      </body>
    </html>
